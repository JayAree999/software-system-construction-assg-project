            ...
            <c:forEach var="user" items="${users}">
                <tr>
                    ...
                    <td class="align-middle">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="delete-modal-${user.id}" tabindex="-1" aria-labelledby="delete-modal-${user.id}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="delete-modal-${user.id}">Delete Confirmation</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                        <div class="modal-body my-4">
                                            Confirm deleting user <b>${user.displayName}</b> with username <b>${user.username}</b> ?
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <a type="button" class="btn btn-danger"
                                               href="/user/delete?username=${user.username}"><i
