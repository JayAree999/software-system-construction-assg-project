        ...
        <div class="col-sm-12 col-md-6 col-lg-4 my-auto">
                ...
                <form action="/login" method="post">
                    <div class="input-group mb-4 input-group-md">
                        ...
                        <input type="text" name="username" class="form-control py-3" placeholder="Username" aria-label="Username" aria-describedby="username">
                    </div>
                    <div class="input-group mb-4 input-group-md">
                            <span class="input-group-text" id="password" style="width: 40px">
                                       <i class="fa fa-key"></i>
                            </span>
                        <input type="password" name="password" class="form-control py-3" placeholder="Password" aria-label="Password" aria-describedby="password">
                    </div>
